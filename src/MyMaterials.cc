...
G4Material *MyMaterials::silicone()
{
  ...
  G4double RefractiveIndex[nEntries_RI] = {1.403, 1.403};
  ...
  //  G4double Absorption[nEntries_RI] =  { 0.1*mm, 0.1*mm, 0.1*mm, 0.1*mm, 0.1*mm, 0.1*mm, 0.1*mm, 0.1*mm};
  G4MaterialPropertiesTable *myMPT = new G4MaterialPropertiesTable();
  myMPT->AddProperty("RINDEX", PhotonEnergy_RI, RefractiveIndex, nEntries_RI);
  //  myMPT->AddProperty("ABSLENGTH", PhotonEnergy_RI,  Absorption,      nEntries_RI);
/*
  const G4int nEntries_tran = 18;
  G4double PhotonEnergy_tran[nEntries_tran] = {4.103235582	*eV,
4.048912761	*eV,
3.944470896	*eV,
3.81331407	*eV,
3.750947295	*eV,
...
2.992445212	*eV,
2.933127681	*eV};
  G4double transIndex[nEntries_tran] = {0.201372	,
0.202705	,
0.211043	,
0.227125	,
0.234102	,
...
0.000935	};
  ...
  myMPT->AddProperty("TRANSMITTANCE", PhotonEnergy_tran, transIndex, nEntries_tran);
...
G4Material *MyMaterials::PWO()
{
  ...
  G4double PhotonEnergy_RI[nEntries_RI] = {1.0 * eV, 1.1 * eV, 1.2 * eV, 1.3 * eV, 1.4 * eV, 1.5 * eV, 1.6 * eV, 1.7 * eV, 1.8 * eV, 1.9 * eV, 2.0 * eV, 2.1 * eV, 2.2 * eV, 2.3 * eV, 2.4 * eV, 2.5 * eV, 2.6 * eV, 2.7 * eV, 2.8 * eV, 2.9 * eV, 3.0 * eV, 3.1 * eV, 3.2 * eV, 3.3 * eV, 3.4 * eV, 3.5 * eV, 3.6 * eV, 3.7 * eV, 3.8 * eV, 3.9 * eV};
  G4double RefractiveIndex[nEntries_RI] = {2.19103, 2.19414, 2.19762, 2.20149, 2.20577, 2.2105, 2.21571, 2.22144, 2.22773, 2.23463, 2.24221, 2.25053, 2.25968, 2.26974, 2.28084, 2.2931, 2.30668, 2.32177, 2.3386, 2.35745, 2.37866, 2.40268, 2.43006, 2.4615, 2.49794, 2.54063, 2.59128, 2.6523, 2.72722, 2.82141};
...
*/
  ...
  const G4int nEntries_ABS = 61;
  G4double Absorption[nEntries_ABS] = {0.02*m, 2.01*m, 4*m, 4.023302971 * m, 4.255916788 * m,4.523924776 * m,4.815007415 * m,5.160917405 * m,5.560374547 * m,6.651855202 * m,
7.330625889 * m,8.593280055 * m,9.708078092 * m,11.15523627 * m,13.0145633 * m,15.48275221 * m,18.70837387 * m,21.38077014 * m,23.02555837 * m,23.63172323 * m,23.9469336 * m,
23.9469336 * m,24.27007742 * m,24.94449849 * m,24.94449849 * m,25.29596276 * m,25.29596276 * m,25.65681445 * m,25.65681445 * m,25.65681445 * m,25.65681445 * m,25.65681445 * m,26.41170567 * m};
  G4double PhotonEnergy_ABS[nEntries_ABS] ={3.44401*eV, 3.41084*eV, 3.37832*eV, 3.376604418 * eV,3.370894244 * eV,3.365833707 * eV,3.358266778 * eV,3.353244055 * eV,3.345733565 * eV,3.330813064 * eV,3.320945706 * eV,3.303804576 * eV,3.2868482 * eV,3.270064988 * eV,3.246373208 * eV,3.220719845 * eV,3.186369517 * eV,3.13949987 * eV,3.089725278 * eV,3.037376425 * eV,2.986779095 * eV,2.937832906 * eV,2.892332871 * eV,2.846415974 * eV,2.801927859 * eV,2.758815138 * eV,2.717003092 * eV,2.678040871 * eV,2.638629504 * eV,2.600355854 * eV,2.563181955 * eV,2.52705078 * eV,2.491924071 * eV};

/*
  const G4int nEntries_ABS = 2;
  G4double Absorption[nEntries_ABS] = {20*m,20*m};
  G4double PhotonEnergy_ABS[nEntries_ABS] ={6 * eV,1 * eV};
*/
  const G4int nEntries_SCY = 12;
  G4double ElectronEnergy_SCY[nEntries_SCY] =
      {0.000 * MeV, 0.015 * MeV, 0.020 * MeV, 0.030 * MeV,
