...
*/
  TH1F *h_phot_lambda_ECAL_f_collect_Ceren;
  TH1F *h_phot_lambda_ECAL_f_collect_Ceren0;
  
  TH1F *h_phot_lambda_ECAL_f_collect_Ceren1;
  TH1F *h_phot_lambda_ECAL_f_collect_Ceren2;
  TH1F *h_phot_lambda_ECAL_f_produce_Ceren;
  TH2F *h_photon_2D_produce_Ceren;
  TH2F *h_photon_2D_receive_Ceren;

  TH1F *h_photon_2D_produce_Ceren_r;
  TH1F *h_photon_2D_produce_Ceren_z;
  TH1F *h_photon_2D_receive_Ceren_r;
  TH1F *h_photon_2D_receive_Ceren_z;
  TH1F *h_phot_lambda_ECAL_collect_Scin;
  TH1F *h_phot_lambda_ECAL_collect_Ceren;
};
